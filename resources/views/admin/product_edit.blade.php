                    ...
                    <div class="flex flex-wrap">
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{ old('name', $product->name) }}" type="text" id="name" name="name"
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{ old('price', $product->price) }}" type="text" id="price" name="price"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                            </div>
                            @error('price')
                                <div class="text-red-300 text-sm">{{ $message }}</div>
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{ old('stock', $product->stock) }}"type="text" id="stock" name="stock"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            @error('stock')
                                <div class="text-red-300 text-sm">{{ $message }}</div>
                        ...
                        @if ($product->cover)
                            <div class="p-2 w-full">
                                ...
                                <a class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" href="{{ route('admin.product.destroyImage', $product->id) }}">Deletar imagem</a>
                            </div>
                        @endif
